...
missdf %>%
  select(tot_rows, percent_day1, percent_day4, percent_day7, miss_analysis, miss_analysis_outcome2, miss_analysis_outcome3) %>%
  round(., digits = 3) %>%
  kable(booktabs = TRUE, align = rep('c',10),
        col.names = c("Total No. Individuals","Day 1","Day 4","Day 7","Day 1, 4, or 7", "BL, Day 1, 4, or 7, or 3-mo", "BL, Day 1, 4, or 7, or 6-mo"),
        row.names = FALSE,
        escape = FALSE,
...
tbl_mod_outcome2 %>%
  ...
  kable(booktabs = TRUE, align = rep('c',4),
        ...
        row.names = TRUE,
        escape = FALSE,
        caption = "Weight loss success at Month 3: Estimates of Parameters in a Logistic Regression Model") %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))
...
tbl_mod_outcome3 %>%
  ...
  kable(booktabs = TRUE, align = rep('c',4),
        ...
        row.names = TRUE,
        escape = FALSE,
        caption = "Weight loss success at Month 6: Estimates of Parameters in a Logistic Regression Model") %>%
  kable_styling(full_width = FALSE, latex_options = c("HOLD_position"))
```
